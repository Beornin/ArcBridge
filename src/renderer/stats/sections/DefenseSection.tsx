    ...
    >
        ...
        {stats.defensePlayers.length === 0 ? (
            ...
            <StatsTableLayout
                ...
                sidebarClassName={`border rounded-[var(--radius-md)] px-3 pt-3 pb-2 flex flex-col min-h-0 ${expandedSection === 'defense-detailed' ? 'h-full flex-1' : 'self-start'}`}
                            ...
                            {(() => {
                                ...
                                return filteredDefenseMetrics.map((metric) => (
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 rounded-[var(--radius-md)] text-xs font-semibold border transition-colors ${activeDefenseStat === metric.id
                                        ...
                                        style={activeDefenseStat !== metric.id ? { background: 'var(--bg-hover)', color: 'var(--text-secondary)' } : undefined}
                                    >
                                        {metric.label}
                                    </button>
                                ));
